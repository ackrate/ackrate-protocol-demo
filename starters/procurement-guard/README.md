...
This starter protects `GET /vendors/:vendorId/quote-packs/:requestId` with a request-bound payment on Stellar testnet. The app asks; the MandateRegistry contract decides whether money moves.
...
- Safety or recovery check: `unauthorized-vendor`
- Expected outcome: A cheaper vendor outside the configured allowlist remains ineligible and cannot be selected for purchase.
