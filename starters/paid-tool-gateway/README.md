...
This starter protects `GET /tools/:toolId/results/:fixtureId` with a request-bound payment on Stellar testnet. The app asks; the MandateRegistry contract decides whether money moves.
...
- Safety or recovery check: `tool-price-ceiling`
- Expected outcome: The offline consumer-policy check rejects a quoted tool price above its declared ceiling before any payment attempt.
