...
- Safety or recovery check: `upstream-not-allowlisted`
- Expected outcome: An upstream route outside the explicit allowlist is rejected before a payment challenge is issued.
