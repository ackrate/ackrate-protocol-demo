...
This starter protects `GET /reviews/:caseId/decision` with a request-bound payment on Stellar testnet. The app asks; the MandateRegistry contract decides whether money moves.
...
- Safety or recovery check: `authority-expires-in-queue`
- Expected outcome: A distinct short-lived mandate expires before settlement against the ready delayed-case fixture, and the contract rejects payment.
