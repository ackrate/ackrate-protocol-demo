...
const faqs = [
  ...
  },
  {
    ...
    answer: "The docs cover the protocol, packages, and integration details. If you are evaluating Ackrate for a real use case, contact us and tell us what the agent needs to do.",
  },
] as const;
...
export default function HomePage() {
  return (
    <main className="ackrate-home relative overflow-hidden bg-[#f4f2ec] text-[#151914] dark:bg-[#0c1611] dark:text-[#f4f2ec]">
      <section className="relative border-b border-[#151914]/15 dark:border-white/15">
        <div className="home-grid pointer-events-none absolute inset-0" aria-hidden />
        <div className="hero-aaa pointer-events-none absolute inset-0 grid place-items-center" aria-hidden>AAA</div>
        <div className="hero-unit relative mx-auto flex min-h-[calc(100svh-4rem)] w-full max-w-[90rem] items-center px-5 py-12 sm:px-8 sm:py-14 lg:px-10 lg:py-8">
          <motion.div
          ...
          >
            <h1 className="home-display text-[clamp(5rem,14vw,12rem)] leading-[0.76] tracking-[-0.075em]">Ackrate</h1>
            <p className="mt-8 max-w-3xl text-2xl font-black leading-tight tracking-[-0.025em] text-[#123d2c] dark:text-[#b9f36a] sm:text-3xl lg:text-4xl">
              A delegation and enforcement layer for autonomous agents
            </p>
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <a href="mailto:consumer-contact@ackrate.com" className="home-button home-button-dark">
                Contact us
                <ArrowRight className="h-4 w-4" aria-hidden />
              </a>
              <Link href="/docs" className="home-button home-button-light">
                Read the docs
      ...
      <section id="one-job" className="scroll-mt-20 border-b border-[#151914]/15 dark:border-white/15">
        <div className="mx-auto w-full max-w-[82rem] px-5 py-20 sm:px-8 sm:py-28 lg:px-10 lg:py-32">
          <motion.div {...fadeUp} className="grid items-end gap-8 lg:grid-cols-[0.72fr_1.28fr] lg:gap-16">
            ...
            <p className="max-w-xl text-lg leading-8 text-[#283128]/65 dark:text-white/60 lg:justify-self-end">
              One job. A few clear edges. A result you can understand without learning how the machinery works.
            </p>
          </motion.div>

          <motion.div {...fadeUp} className="mt-12 overflow-hidden rounded-[2rem] border border-[#151914]/20 bg-white shadow-[0_28px_80px_-48px_rgba(18,61,44,0.55)] dark:border-white/15 dark:bg-[#111e18]">
            <div className="grid lg:grid-cols-[1.18fr_0.82fr]">
              ...
              <div className="flex items-center border-t border-[#151914]/15 bg-[#e7f1e6] p-6 dark:border-white/15 dark:bg-[#162a21] sm:p-10 lg:border-l lg:border-t-0 lg:p-12">
                <div>
                  ...
                  <p className="mt-2 text-base leading-7 text-[#283128]/65 dark:text-white/60">$28 stayed unspent. The permission is now closed.</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="border-b border-[#151914]/15 bg-[#fffdf8] dark:border-white/15 dark:bg-[#101c16]">
        <div className="mx-auto grid w-full max-w-[82rem] gap-10 px-5 py-20 sm:px-8 sm:py-28 lg:grid-cols-[0.72fr_1.28fr] lg:gap-20 lg:px-10 lg:py-32">
          ...
          <motion.div {...fadeUp}>
            ...
            <p className="mt-8 max-w-3xl text-lg leading-8 text-[#283128]/68 dark:text-white/65 sm:text-xl sm:leading-9">
              Ackrate is building the <strong className="font-semibold text-[#151914] dark:text-[#f4f2ec]">delegation and enforcement layer for</strong> autonomous <strong className="font-semibold text-[#151914] dark:text-[#f4f2ec]">agents</strong>.
            </p>
            <p className="mt-4 max-w-3xl text-lg leading-8 text-[#283128]/68 dark:text-white/65 sm:text-xl sm:leading-9">
              <strong className="font-semibold text-[#151914] dark:text-[#f4f2ec]">AI agents are becoming capable of spending money</strong>, buying services, calling paid APIs, and coordinating with other agents.
            </p>
            <p className="mt-4 max-w-3xl text-lg leading-8 text-[#283128]/68 dark:text-white/65 sm:text-xl sm:leading-9">
              But <strong className="font-semibold text-[#151914] dark:text-[#f4f2ec]">today, giving an agent the ability to act often means giving it access to credentials</strong>, wallets, or payment methods that are far more powerful than the task actually requires.
            </p>
            <p className="mt-4 max-w-3xl text-lg leading-8 text-[#283128]/68 dark:text-white/65 sm:text-xl sm:leading-9">
              <strong className="font-semibold text-[#151914] dark:text-[#f4f2ec]">Ackrate lets a person, organization, or parent agent delegate a specific set of permissions to an subagent</strong>: how much it can spend, where it can spend it, what resources it can access, how long the authority lasts, and whether it can delegate part of that authority further.
            </p>
            <p className="mt-4 max-w-3xl text-lg leading-8 text-[#283128]/68 dark:text-white/65 sm:text-xl sm:leading-9">Those constraints are enforced independently of the agent itself.</p>
          </motion.div>
        </div>
      </section>

      <section id="how-it-works" className="scroll-mt-20 border-b border-[#151914]/15 dark:border-white/15">
        <div className="mx-auto grid w-full max-w-[82rem] items-center gap-14 px-5 py-20 sm:px-8 sm:py-28 lg:grid-cols-[0.92fr_1.08fr] lg:gap-20 lg:px-10 lg:py-32">
          <motion.div {...fadeUp}>
            ...
            <p className="mt-7 max-w-xl text-lg leading-8 text-[#283128]/68 dark:text-white/65">Those constraints are enforced independently of the agent itself. The agent gets enough authority to help—and no more.</p>
          </motion.div>

          <motion.div {...fadeUp} className="rounded-[2rem] border border-[#151914]/20 bg-[#e7f1e6] p-5 dark:border-white/15 dark:bg-[#162a21] sm:p-8">
      ...
      <section className="border-b border-[#151914]/15 bg-[#fffdf8] dark:border-white/15 dark:bg-[#101c16]">
        <div className="mx-auto w-full max-w-[82rem] px-5 py-20 sm:px-8 sm:py-28 lg:px-10 lg:py-32">
          <motion.div {...fadeUp} className="max-w-5xl">
            ...
            <p className="mt-7 max-w-2xl text-lg leading-8 text-[#283128]/65 dark:text-white/60">Broad access makes a small task carry a very large risk. A bounded permission keeps the authority proportional to the work.</p>
          </motion.div>

          <motion.div {...fadeUp} className="mt-12 grid overflow-hidden rounded-[2rem] border border-[#151914]/20 dark:border-white/15 lg:grid-cols-2">
            <ComparisonColumn
              eyebrow="The old way"
              tone="old"
              items={[
      ...
      <section id="contact" className="scroll-mt-20 border-b border-[#151914]/15 bg-[#b9f36a]">
        <motion.div {...fadeUp} className="mx-auto flex w-full max-w-[82rem] flex-col gap-10 px-5 py-20 sm:px-8 sm:py-24 lg:flex-row lg:items-end lg:justify-between lg:gap-20 lg:px-10 lg:py-28">
          <div className="max-w-4xl">
            <p className="home-kicker">Talk to Ackrate</p>
            <h2 className="home-display mt-5 text-5xl leading-[0.93] tracking-[-0.05em] sm:text-6xl lg:text-8xl">Planning to let an agent <em>spend or act?</em></h2>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-[#123d2c]/75">Tell us what the agent needs to do and which boundaries matter.</p>
          </div>
          <div className="flex shrink-0 flex-col gap-3 sm:flex-row lg:flex-col">
            <a href="mailto:consumer-contact@ackrate.com" className="home-button home-button-dark">Email us <ArrowRight className="h-4 w-4" aria-hidden /></a>
            <a href="mailto:consumer-contact@ackrate.com" className="text-center text-sm font-black text-[#123d2c] underline decoration-[#123d2c]/30 underline-offset-4 hover:decoration-[#123d2c]">consumer-contact@ackrate.com</a>
            <Link href="/docs" className="home-button border border-[#151914]/25 bg-transparent text-[#151914] hover:bg-white/40">Read the docs</Link>
          </div>
        </motion.div>
      </section>

      <section className="bg-[#f4f2ec] dark:bg-[#0c1611]">
        <div className="mx-auto grid w-full max-w-[82rem] gap-10 px-5 py-20 sm:px-8 sm:py-28 lg:grid-cols-[0.65fr_1.35fr] lg:gap-20 lg:px-10 lg:py-32">
          ...
          <motion.div {...fadeUp} className="border-t border-[#151914]/20 dark:border-white/15">
            {faqs.map((faq) => (
              <details key={faq.question} className="group border-b border-[#151914]/20 py-1 dark:border-white/15">
                ...
                <p className="max-w-2xl pb-7 pr-8 text-base leading-7 text-[#283128]/65 dark:text-white/60">{faq.answer}</p>
              </details>
            ))}
          </motion.div>
        </div>
...
function EnforcementRow({ number, title, copy, featured = false }: { number: string; title: string; copy: string; featured?: boolean }) {
  return (
    <div className={`grid grid-cols-[auto_1fr] items-center gap-4 rounded-2xl border p-5 sm:gap-6 sm:p-6 ${featured ? "border-[#157a4b] bg-[#123d2c] text-white shadow-xl" : "border-[#151914]/15 bg-[#fffdf8] dark:border-white/15 dark:bg-[#101c16]"}`}>
      <span className={`home-display text-3xl ${featured ? "text-[#b9f36a]" : "text-[#157a4b]"}`}>{number}</span>
      <div>
        <h3 className="text-lg font-black tracking-tight">{title}</h3>
        <p className={`mt-1 text-sm leading-6 ${featured ? "text-white/60" : "text-[#283128]/60 dark:text-white/60"}`}>{copy}</p>
      </div>
    </div>
  );
}
...
function ComparisonColumn({ eyebrow, tone, items }: { eyebrow: string; tone: "old" | "new"; items: readonly (readonly [string, string])[] }) {
  ...
  return (
    <div className={`${fresh ? "bg-[#e7f1e6] dark:bg-[#162a21]" : "bg-[#eeeae2] dark:bg-[#17201b]"} p-6 sm:p-10 lg:p-12 ${fresh ? "border-t border-[#151914]/20 dark:border-white/15 lg:border-l lg:border-t-0" : ""}`}>
      ...
      <div className="mt-8 space-y-8">
        {items.map(([title, copy]) => (
          <div key={title} className="grid grid-cols-[auto_1fr] gap-4">
            ...
            <div>
              <h3 className="text-lg font-black tracking-tight">{title}</h3>
              <p className="mt-1 text-sm leading-6 text-[#283128]/62 dark:text-white/60 sm:text-base sm:leading-7">{copy}</p>
            </div>
          </div>
        ))}
      </div>
