...
export default function QuickStarters() {
  ...
  return <><p className="eyebrow">Docs / Quick starters</p><h1>Run the whole flow.</h1>
    ...
    <CodeBlock>{command}</CodeBlock><button className="secondary-action" onClick={copy}>Copy setup command</button><span className="copy-status" role="status">{copyState}</span>
