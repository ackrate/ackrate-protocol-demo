...
export default function SdkDocs() {
  return <><p className="eyebrow">Docs / SDK</p><h1>Payments from TypeScript.</h1>
    ...
    <h2>Install</h2><CodeBlock>npm install @ackrate/core@0.4.1 @ackrate/stellar@0.3.0 @stellar/stellar-sdk@16.3.0</CodeBlock>
    ...
    <CodeBlock language="typescript">{`import { ackrate } from "@ackrate/core";
