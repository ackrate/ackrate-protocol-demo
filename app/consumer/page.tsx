  ...
  return (
    <main className="relative overflow-hidden pb-8">
      ...
      <section className="mx-auto grid w-full max-w-6xl gap-10 px-4 pb-16 pt-12 sm:px-6 lg:grid-cols-[1fr_0.92fr] lg:items-center lg:px-8 lg:pb-24 lg:pt-20">
        <motion.div {...fade()}>
          <div className="inline-flex items-center gap-2 rounded-full border border-neutral-300/15 bg-neutral-400/[0.06] px-3.5 py-1.5 text-[11px] font-semibold tracking-[0.18em] text-neutral-300/90">
          ...
          <h1 className="mt-6 max-w-3xl text-4xl font-black tracking-[-0.04em] text-white sm:text-6xl lg:text-7xl">
            Give AI a job.{" "}
            <span className="bg-gradient-to-r from-neutral-300 via-neutral-300 to-neutral-300 bg-clip-text text-transparent">
              Not a blank check.
            </span>
          </h1>
          <p className="mt-6 max-w-2xl text-base leading-relaxed text-neutral-50/65 sm:text-lg">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <a
              ...
              className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-neutral-400 px-5 py-3 text-sm font-bold text-[#000000] shadow-[0_0_30px_rgba(255,255,255,0.3)] transition hover:bg-neutral-300"
            >
            ...
            <a
              href="#how-it-works"
              className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-white/15 bg-white/[0.025] px-5 py-3 text-sm font-semibold text-neutral-50/80 transition hover:border-neutral-300/30 hover:text-white"
            >
              See how it works
            </a>
          </div>
            ...
            {[
              ...
              return (
                <div key={String(title)} className="rounded-2xl border border-white/[0.08] bg-black/20 p-4">
                  <FeatureIcon className="h-4 w-4 text-neutral-300" aria-hidden />
                  <p className="mt-3 text-sm font-semibold text-neutral-50">{String(title)}</p>
        ...
        <motion.div {...fade(0.08)} className="relative mx-auto w-full max-w-xl">
          <div className="absolute -inset-6 -z-10 rounded-[2.5rem] bg-neutral-400/[0.08] blur-3xl" aria-hidden />
          <div className="overflow-hidden rounded-[2rem] border border-neutral-300/15 bg-[#090909]/95 shadow-[0_32px_90px_rgba(0,0,0,0.45)]">
            <div className="flex items-center justify-between border-b border-white/[0.08] px-5 py-4">
              ...
              <span className="rounded-full border border-neutral-300/15 bg-neutral-400/[0.07] px-2.5 py-1 text-[10px] font-semibold text-neutral-300">
                CONTROLLED
              </span>
            </div>
            ...
            <div className="p-5 sm:p-6">
              ...
              <div className="mt-6 rounded-2xl border border-white/[0.08] bg-black/25 p-4">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-semibold text-neutral-50">What the rules allow</p>
                  <CheckCircle2 className="h-4 w-4 text-neutral-300" aria-hidden />
                </div>
              ...
              <a
                href="#mandate-builder"
                className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-neutral-400 px-4 py-3 text-sm font-bold text-[#000000] transition hover:bg-neutral-300"
              >
      ...
      <section id="mandate-builder" className="scroll-mt-24 border-y border-white/[0.07] bg-black/20">
        <div className="mx-auto grid w-full max-w-6xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[0.72fr_1.28fr] lg:px-8 lg:py-24">
          <motion.div {...fade()} className="lg:sticky lg:top-28 lg:self-start">
            <div className="grid h-12 w-12 place-items-center rounded-2xl border border-neutral-300/15 bg-neutral-400/10 text-neutral-300">
            ...
            <p className="mt-4 text-sm leading-relaxed text-neutral-50/60 sm:text-base">
              You choose the job and the limits. ACKRATE prepares a plain-language summary before the agent receives any
              payment authority.
            </p>
            <div className="mt-6 space-y-3 text-sm text-neutral-50/65">
              {[
                ...
                <p key={rule} className="flex gap-2.5">
                  <Check className="mt-0.5 h-4 w-4 flex-none text-neutral-300" aria-hidden />
                  {rule}
                </p>
              ))}
            </div>
          ...
          <motion.div {...fade(0.08)} className="rounded-[2rem] border border-white/[0.09] bg-[#08100e]/90 p-5 shadow-[0_24px_70px_rgba(0,0,0,0.3)] sm:p-7">
            <div className="flex flex-col gap-3 border-b border-white/[0.08] pb-5 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.16em] text-neutral-300/75">Spending controls</p>
            ...
            <div className="mt-6 space-y-5">
              <label className="block">
                <span className="text-sm font-medium text-neutral-50/80">What should the agent accomplish?</span>
                <textarea
                  value={task}
                  onChange={(event) => {
                  ...
                  rows={4}
                  className="mt-2 w-full resize-none rounded-xl border border-white/10 bg-black/30 px-4 py-3 text-sm leading-relaxed text-white outline-none transition placeholder:text-white/25 focus:border-neutral-300/40 focus:ring-2 focus:ring-neutral-400/10"
                />
              </label>

              <div className="grid gap-4 sm:grid-cols-2">
                <label className="block">
                  <span className="text-sm font-medium text-neutral-50/80">Never spend more than</span>
                  <span className="mt-2 flex items-center rounded-xl border border-white/10 bg-black/30 px-4 focus-within:border-neutral-300/40 focus-within:ring-2 focus-within:ring-neutral-400/10">
              ...
              {previewState === "draft" ? (
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex gap-3">
                    <ShieldCheck className="mt-0.5 h-5 w-5 flex-none text-neutral-300" aria-hidden />
                    <div>
                      <p className="text-sm font-semibold text-neutral-50">Ready to review</p>
                  ...
                  <button
                    ...
                    className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-neutral-400 px-4 py-2.5 text-sm font-bold text-[#000000] transition hover:bg-neutral-300 disabled:cursor-not-allowed disabled:opacity-40"
                  >
                ...
                <div>
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <div className="flex gap-3">
                      <span className={`grid h-9 w-9 flex-none place-items-center rounded-xl ${previewState === "paused" ? "bg-amber-300/10 text-amber-200" : "bg-neutral-400/10 text-neutral-300"}`}>
                    ...
                    <span className={`rounded-full px-2.5 py-1 text-[10px] font-semibold ${previewState === "paused" ? "bg-amber-300/10 text-amber-200" : "bg-neutral-400/10 text-neutral-300"}`}>
                  ...
                  <div className="mt-5 flex flex-wrap gap-2">
                    <button
                      ...
                      className="inline-flex items-center gap-2 rounded-lg border border-white/10 px-3 py-2 text-xs font-semibold text-neutral-50/70 transition hover:border-neutral-300/30 hover:text-white"
                    >
      ...
      <section id="how-it-works" className="scroll-mt-24 mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <motion.div {...fade()} className="max-w-2xl">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-neutral-300/75">How it works</p>
          ...
          {[
            ...
            return (
              <article key={String(number)} className="relative overflow-hidden rounded-2xl border border-white/[0.08] bg-white/[0.025] p-5">
                ...
                <StepIcon className="h-5 w-5 text-neutral-300" aria-hidden />
                <h3 className="mt-5 text-base font-semibold text-neutral-50">{String(title)}</h3>
        ...
        <motion.div {...fade(0.08)} className="mt-12 grid overflow-hidden rounded-[2rem] border border-white/[0.09] bg-black/25 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="p-6 sm:p-8 lg:p-10">
            <div className="grid h-11 w-11 place-items-center rounded-2xl bg-neutral-400/10 text-neutral-300">
              <LockKeyhole className="h-5 w-5" aria-hidden />
            </div>
            <h2 className="mt-5 text-2xl font-bold text-white">Your agent can act. It cannot rewrite the rules.</h2>
            <p className="mt-4 text-sm leading-relaxed text-neutral-50/60">
            ...
            <Link
              href="/ap2"
              className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-neutral-300 transition hover:text-neutral-200"
            >
      ...
      <section className="mx-auto w-full max-w-6xl px-4 pb-16 sm:px-6 lg:px-8 lg:pb-24">
        <motion.div {...fade()} className="rounded-[2rem] border border-neutral-300/15 bg-gradient-to-br from-neutral-400/[0.11] via-[#07110e] to-neutral-400/[0.05] p-6 sm:p-9 lg:flex lg:items-center lg:justify-between lg:gap-10">
          <div className="max-w-2xl">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-neutral-300/80">See it working</p>
            ...
            <p className="mt-3 text-sm leading-relaxed text-neutral-50/60">
          ...
          <div className="mt-6 flex flex-wrap gap-3 lg:mt-0 lg:flex-none">
            <Link href="/express" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-neutral-400 px-4 py-2.5 text-sm font-bold text-[#000000] transition hover:bg-neutral-300">
              See the live research demo
              <ArrowRight className="h-4 w-4" aria-hidden />
            </Link>
            <Link href="/solutions" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-white/15 px-4 py-2.5 text-sm font-semibold text-neutral-50/75 transition hover:border-neutral-300/30 hover:text-white">
              Build with ACKRATE
            </Link>
          </div>
        </motion.div>
...
function PreviewStat({ label, value, Icon }: { label: string; value: string; Icon: typeof Gauge }) {
  return (
    <div className="rounded-xl border border-white/[0.08] bg-white/[0.025] p-3.5">
      ...
      <p className="mt-1 text-xs font-semibold text-neutral-50">{value}</p>
    </div>
  );
}
...
function FlowRow({ status, label, amount }: { status: "allowed" | "blocked"; label: string; amount: string }) {
  return (
    <div className="flex items-center gap-3 text-xs">
      <span className={`grid h-6 w-6 flex-none place-items-center rounded-full ${status === "allowed" ? "bg-neutral-400/10 text-neutral-300" : "bg-rose-400/10 text-rose-300"}`}>
...
function SelectField<T extends string>({
  ...
  return (
    <label className="block">
      <span className="text-sm font-medium text-neutral-50/80">{label}</span>
      <select
        value={value}
        onChange={(event) => onChange(event.target.value as T)}
        className="mt-2 w-full rounded-xl border border-white/10 bg-[#080d0c] px-4 py-3 text-sm text-white outline-none transition focus:border-neutral-300/40 focus:ring-2 focus:ring-neutral-400/10"
      >
...
function SummaryItem({ term, value }: { term: string; value: string }) {
  return (
    <div className="rounded-xl border border-white/[0.07] bg-white/[0.025] p-3.5">
      ...
      <dd className="mt-1.5 text-xs font-semibold text-neutral-50">{value}</dd>
    </div>
  );
}
...
function DecisionRow({ label, detail, allowed = false }: { label: string; detail: string; allowed?: boolean }) {
  return (
    <div className="flex items-center gap-3 rounded-xl border border-white/[0.07] bg-black/20 p-3.5">
      <span className={`grid h-8 w-8 flex-none place-items-center rounded-lg ${allowed ? "bg-neutral-400/10 text-neutral-300" : "bg-rose-400/10 text-rose-300"}`}>
        {allowed ? <Check className="h-4 w-4" aria-hidden /> : <X className="h-4 w-4" aria-hidden />}
      </span>
      <div className="min-w-0 flex-1">
        <p className="text-sm font-medium text-neutral-50">{label}</p>
        <p className="mt-0.5 text-xs text-white/35">{detail}</p>
      </div>
      <span className={`text-[10px] font-semibold ${allowed ? "text-neutral-300" : "text-rose-300"}`}>
        {allowed ? "ALLOW" : "BLOCK"}
      </span>
    </div>
  );
